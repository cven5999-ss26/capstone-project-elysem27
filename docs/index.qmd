...
Even though C&I have the largest daily kWh usage, SME accounts for the largest share of energy use, followed by Residential and C&I based on the sheer number of households and SMEs compared to the larger industrial partners.
...
#| message: false
#| warning: false
#| fig-alt: "A stacked chart showing total daily energy loads across calendar days, filtered to exclude rows with zero peak load. Each bar represents a single day's total consumption, color-coded by connection type to illustrate contribution to peak load."
...
ggplot(daily_composition, aes(x = Date, y = Max_kWh_peak, fill = customer_type)) +
  ...
  labs(
    ...
    subtitle = "Aggregated daily totals highlighting peak demand periods",
    x = "Date",
